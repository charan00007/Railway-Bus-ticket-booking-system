...
.ticketdesign {
  background: linear-gradient(to bottom, #2980B9 0%, #2980B9 19%, #d9d9d9 19%, #d9d9d9 100%);
  height: 30em;
  float: left;
...
<h1 align="left"><b>Railway/Bus Ticket Booking</b>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<b>Bus-Ticket</b>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Ticket No : <?php echo $row['T_No.'] ?> </h1></span>
    <div class="title">
    	<br>
